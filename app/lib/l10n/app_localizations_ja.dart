...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get createPersonHint => '新しい人を作成して、Tokiにその人の声も認識させましょう！';
  ...
  @override
  String get deletingMessages => 'Tokiのメモリからメッセージを削除しています...';
  ...
  @override
  String get chatWithOmi => 'Tokiとチャット';
  ...
  @override
  String get getOmiForMac => 'Mac用Tokiを入手';
  ...
  @override
  String get connectDeviceMessage => 'デバイス設定とカスタマイズにアクセスするには、Tokiデバイスを接続してください';
  ...
  @override
  String get yourOmiInsights => 'Tokiの分析情報';
  ...
  @override
  String get startConversationToSeeInsights => 'Tokiと会話を始めて\n分析情報をここに表示しましょう。';

  @override
  String get listening => 'リスニング';

  @override
  String get listeningSubtitle => 'Tokiがアクティブにリスニングした合計時間。';
  ...
  @override
  String get shareStatsMessage => 'Tokiの統計をシェア！(omi.me - 常時ONのAIアシスタント)';

  @override
  String get sharePeriodToday => '今日、Tokiは:';

  @override
  String get sharePeriodMonth => '今月、Tokiは:';

  @override
  String get sharePeriodYear => '今年、Tokiは:';

  @override
  String get sharePeriodAllTime => 'これまで、Tokiは:';
  ...
  @override
  String get omiDebugLog => 'Tokiデバッグログ';
  ...
  @override
  String get exportedConversations => 'Tokiからエクスポートされた会話';
  ...
  String authAccessMessage(String appName) {
    return 'Tokiが$appNameのデータにアクセスすることを許可する必要があります。ブラウザで認証が開きます。';
  }
  ...
  @override
  String get howShouldOmiCallYou => 'Tokiはあなたをどう呼べばいいですか？';
  ...
  String authorizeOmiForTasks(String appName) {
    return 'Tokiが$appNameアカウントでタスクを作成することを許可する必要があります。ブラウザで認証が開きます。';
  }
  ...
  String deviceUsesCodec(String device, String reason) {
    return '$deviceは$reasonを使用しています。Tokiが使用されます。';
  }

  @override
  String get omiTranscription => 'Toki文字起こし';
  ...
  @override
  String get backgroundActivityDesc => 'より安定した動作のためにTokiをバックグラウンドで実行させる';
  ...
  @override
  String get lovingOmi => 'Tokiを楽しんでいますか？';
  ...
  @override
  String get speechProfileIntro => 'Tokiはあなたの目標と声を学ぶ必要があります。後で変更できます。';
  ...
  @override
  String get connectOmiOmiGlass => 'Toki / TokiGlassを接続';
  ...
  @override
  String get omiYourAiCompanion => 'Toki – あなたのAIコンパニオン';
  ...
  @override
  String get clearMemoryTitle => 'Tokiのメモリを消去';

  @override
  String get clearMemoryMessage => 'Tokiのメモリを消去してもよろしいですか？この操作は取り消せません。';

  @override
  String get clearMemoryButton => 'メモリをクリア';

  @override
  String get memoryClearedSuccess => 'Tokiのあなたに関するメモリが消去されました';
  ...
  @override
  String get omiSyncsAudioFiles => 'Tokiはその後、オーディオファイルをサーバーと同期します';
  ...
  @override
  String get welcomeToOmiDescription => 'Tokiへようこそ！あなたのAIコンパニオンは、会話、タスクなどでお手伝いする準備ができています。';

  @override
  String get startUsingOmi => 'Tokiの使用を開始';
  ...
  @override
  String get startCapturingConversations => 'Tokiデバイスで会話のキャプチャを開始して、ここに表示します。';
  ...
  @override
  String get getOmiDevice => 'Tokiデバイスを入手';
  ...
  @override
  String get permanentlyRemoveAllMemories => 'Tokiからすべてのメモリを完全に削除';
  ...
  @override
  String get clearOmisMemory => 'Tokiのメモリをクリア';

  @override
  String clearMemoryConfirmation(int count) {
    return 'Tokiのメモリをクリアしてもよろしいですか？この操作は元に戻せず、すべての$count個のメモリが完全に削除されます。';
  }

  @override
  String get omisMemoryCleared => 'あなたに関するTokiのメモリがクリアされました';

  @override
  String get welcomeToOmi => 'Tokiへようこそ';
  ...
  @override
  String get selectPreferredLanguageForBestExperience => '最高のToki体験のために優先言語を選択してください';
  ...
  @override
  String get tellUsHowYouWouldLikeToBeAddressed => 'どのように呼ばれたいか教えてください。これにより、Toki体験をパーソナライズできます。';
  ...
  @override
  String get enableFeaturesForBestExperience => 'デバイスで最高のToki体験を得るために機能を有効にしてください。';
  ...
  @override
  String get microphoneAccessDescription => 'Tokiは会話を録音し、文字起こしを提供するためにマイクアクセスが必要です。';
  ...
  @override
  String get screenRecordingDescription => 'Tokiは、ブラウザベースの会議からシステムオーディオをキャプチャするために画面録画権限が必要です。';
  ...
  @override
  String get accessibilityDescription => 'Tokiは、ブラウザでZoom、Meet、またはTeamsの会議に参加したことを検出するためにアクセシビリティ権限が必要です。';
  ...
  @override
  String get manageYourOmiPersona => 'Tokiペルソナを管理';

  @override
  String get voiceAndPeople => '音声と人物';

  @override
  String get teachOmiYourVoice => 'Tokiにあなたの声を教える';

  @override
  String get tellOmiWhoSaidIt => '誰が言ったかTokiに伝える 🗣️';
  ...
  @override
  String get helpImproveOmiBySharing => '匿名化された分析データを共有してTokiの改善にご協力ください';
  ...
  @override
  String get mcpDescription => 'Tokiを他のアプリケーションに接続して、記憶と会話を読み取り、検索し、管理します。開始するにはキーを作成してください。';
  ...
  @override
  String get tryLatestExperimentalFeatures => 'Tokiチームの最新の実験的機能をお試しください。';
  ...
  @override
  String get letOmiChooseAutomatically => 'Tokiに最適なアプリを自動的に選択させる';
  ...
  @override
  String get addWordsDescription => '文字起こし中にTokiが認識すべき単語を追加します。';
  ...
  @override
  String get connectOmiWithAI => 'Toki を AI アシスタントに接続';
  ...
  @override
  String get bySubmittingYouAgreeToOmi => '送信することで、Tokiの';
  ...
  @override
  String get dataAccessNoticeDescription => 'このアプリはあなたのデータにアクセスします。Toki AIは、このアプリによるデータの使用、変更、削除について責任を負いません';
  ...
  String get e2eeDescription =>
      'エンドツーエンド暗号化はプライバシーの最高基準です。有効にすると、データはサーバーに送信される前にデバイス上で暗号化されます。これは、Tokiを含め、誰もあなたのコンテンツにアクセスできないことを意味します。';
  ...
  String get secureEncryptionDescription =>
      'あなたのデータは、Google Cloudでホストされている当社のサーバー上で、あなた固有の鍵で暗号化されています。これは、生のコンテンツがTokiスタッフやGoogleを含む誰にも、データベースから直接アクセスできないことを意味します。';
  ...
  @override
  String get omiTraining => 'Toki トレーニング';

  @override
  String get trainingDataProgram => 'トレーニングデータプログラム';

  @override
  String get getOmiUnlimitedFree => 'AIモデルのトレーニングにデータを提供することで、Toki Unlimitedを無料で入手できます。';
  ...
  @override
  String get yourOmiUnleashed => 'あなたのTokiを解き放とう。無限の可能性のためにUnlimitedへ。';
  ...
  @override
  String get askOmiAnything => 'Tokiにあなたの人生について何でも聞いてください';

  @override
  String get unlockOmiInfiniteMemory => 'Tokiの無限メモリーをアンロック';
  ...
  String get unableToOpenWatchApp =>
      'Apple Watchアプリを開けませんでした。Apple WatchのWatchアプリを手動で開き、「利用可能なApp」セクションからTokiをインストールしてください。';
  ...
  @override
  String get addVocabularyDescription => '文字起こし中にTokiが認識すべき単語を追加します。';
  ...
  @override
  String get wrappedOmiLifeRecap => 'Tokiライフまとめ';

  @override
  String get wrappedSwipeUpToBegin => '上にスワイプして開始';

  @override
  String get wrappedShareText => '私の2025年、Tokiが記録 ✨ omi.me/wrapped';
  ...
  @override
  String get wrappedRememberedByOmi => 'Tokiが記録';
  ...
  @override
  String get controlNotificationFrequency => 'Tokiがプロアクティブ通知を送信する頻度を制御します。';
  ...
  @override
  String get audioFromOmiWillAppearHere => 'Tokiデバイスからのオーディオがここに表示されます';
  ...
  @override
  String get considerOmiCloud => 'パフォーマンス向上のためToki Cloudの使用を検討してください。';
  ...
  @override
  String get setupQuestionsIntro => 'いくつかの質問に答えて、Tokiの改善にご協力ください。🫶 💜';

  @override
  String get setupQuestionProfession => '1. あなたのお仕事は何ですか？';

  @override
  String get setupQuestionUsage => '2. どこでTokiを使用する予定ですか？';
  ...
  @override
  String get deviceDisconnectedNotificationTitle => 'Tokiデバイスが切断されました';

  @override
  String get deviceDisconnectedNotificationBody => 'Tokiを引き続き使用するには再接続してください。';
  ...
  String firmwareUpdateAvailableDescription(String version) {
    return 'Tokiデバイスの新しいファームウェアアップデート（$version）が利用可能です。今すぐアップデートしますか？';
  }
  ...
  @override
  String get connectOmiDevice => 'Tokiデバイスを接続';
  ...
  @override
  String get actionItemReminderTitle => 'Tokiリマインダー';
  ...
  @override
  String get onboardingWelcomeToOmi => 'Tokiへようこそ';
  ...
  @override
  String get pairingTitleOmi => 'Tokiの電源を入れる';
  ...
  @override
  String get phoneCallsWithOmi => 'Tokiで通話';
  ...
  @override
  String get phoneCallsUnlimitedOnly => 'Tokiで電話をかける';

  @override
  String get phoneCallsUpsellSubtitle => 'Tokiで通話し、リアルタイム文字起こし、自動要約などを取得。';
  ...
  String get fairUseAboutBody =>
      'Tokiは個人的な会話、会議、ライブのやり取りのために設計されています。使用量は接続時間ではなく、検出された実際の発話時間で測定されます。非個人的なコンテンツに対して通常のパターンを大幅に超える使用がある場合、調整が適用されることがあります。';
  ...
  String get improveConnectionContent =>
      'Tokiがデバイスとの接続を維持する方法を改善しました。これを有効にするには、デバイス情報ページに移動し、「デバイスを切断」をタップしてから、デバイスを再度ペアリングしてください。';
