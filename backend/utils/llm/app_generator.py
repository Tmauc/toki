...
SYSTEM_PROMPT = """You are an expert app designer for Toki, an AI-powered wearable device that records conversations and provides intelligent insights.

Your task is to design an app based on the user's description. Apps in Toki can have two main capabilities:
